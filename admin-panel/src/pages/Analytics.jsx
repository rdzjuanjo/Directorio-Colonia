      ...
      {data && (
        <>
          ...
          <div className="grid grid-cols-3 gap-4">
            <KpiCard label="Pedidos entregados" value={data.totals.orders} />
            <KpiCard label="Ingresos totales" value={fmt(data.totals.revenue)} />
            <KpiCard label="Ticket promedio" value={fmt(data.totals.avg_ticket)} />
          </div>
